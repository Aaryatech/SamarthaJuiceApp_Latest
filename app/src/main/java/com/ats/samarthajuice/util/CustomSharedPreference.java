...
public class CustomSharedPreference {
    ...
    public static String PREFERENCE_NAME = "HappyFeast";
    public static String PREFERENCE_NAME_PRINTER = "SamarthPrinter";
    public static String KEY_ADMIN = "Admin";
    public static String KEY_TABLE_CAT_ID = "TableCatId";

    public static String KEY_BILL_IP = "BillIP";
    public static String KEY_BILL_PORT = "BillPort";
    public static String KEY_KOT_IP = "KOTIP";
    ...
    public static void putStringPrinter(Context activity, String key, String value) {
        SharedPreferences shared = activity.getSharedPreferences(PREFERENCE_NAME_PRINTER, Context.MODE_PRIVATE);
        SharedPreferences.Editor edt = shared.edit();
        edt.putString(key, value);
        edt.commit();
    }
    ...
    public static String getStringPrinter(Context activity, String key) {
        SharedPreferences shared = activity.getSharedPreferences(PREFERENCE_NAME_PRINTER, Context.MODE_PRIVATE);
        String val = shared.getString(key, null);
        return shared.getString(key, null);
    }
