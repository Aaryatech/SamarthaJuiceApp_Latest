...
import com.ats.samarthajuice.fragment.HomeFragment;
import com.ats.samarthajuice.fragment.ItemMasterFragment;
import com.ats.samarthajuice.fragment.ItemReportFragment;
import com.ats.samarthajuice.fragment.OpenBillFragment;
import com.ats.samarthajuice.fragment.PrinterSettingsFragment;
...
public class HomeActivity extends AppCompatActivity
    ...
    private void hideItem() {
        ...
        if (userType.equalsIgnoreCase("Captain")) {
            ...
            nav_Menu.findItem(R.id.nav_edit_bill).setVisible(false);
            nav_Menu.findItem(R.id.nav_open_edit_bill).setVisible(false);
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            dialog.show();
                ...
                homeFragment instanceof OpenBillFragment && homeFragment.isVisible() ||
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_open_edit_bill) {
            FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                   ...
                   // CustomSharedPreference.deletePreference(HomeActivity.this);
                    ...
                    CustomSharedPreference.deletePreferenceByKey(HomeActivity.this,CustomSharedPreference.PREFERENCE_NAME);
