...
public class VerifyOrderItemModelAdapter extends RecyclerView.Adapter<VerifyOrderItemModelAdapter.MyViewHolder> {


    private ArrayList<ItemModel> itemList;
    private Context context;

    public VerifyOrderItemModelAdapter(ArrayList<ItemModel> itemList, Context context) {
