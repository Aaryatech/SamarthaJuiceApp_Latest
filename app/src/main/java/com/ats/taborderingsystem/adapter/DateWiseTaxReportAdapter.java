...
public class DateWiseTaxReportAdapter extends RecyclerView.Adapter<DateWiseTaxReportAdapter.MyViewHolder> {

    private ArrayList<BillWiseTaxReportModel> reportList;
    private Context context;

    public DateWiseTaxReportAdapter(ArrayList<BillWiseTaxReportModel> reportList, Context context) {
