...
import com.ats.taborderingsystem.adapter.MenuItemAdapter;
import com.ats.taborderingsystem.adapter.MenuItemForSearchAdapter;
import com.ats.taborderingsystem.adapter.VerifyOrderAdapter;
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < itemList.size(); i++) {
                    if (itemList.get(i).getQty() > 0) {
                        ...
                        ParcelOrderDetails orderDetails = new ParcelOrderDetails(0, 0, item.getItemId(), item.getQty(), item.getMrpRegular(), 1, 0, "na", item.getItemName());
                    ...
                    try {
                        if (response.body() != null) {
                            ...
                            if (data == null) {
                                ...
                                try {
                                    String ip = CustomSharedPreference.getString(ParcelMenuWithSearchActivity.this, CustomSharedPreference.KEY_KOT_IP);
...
//                                }
                                ...
                                try {
                                    String ip = CustomSharedPreference.getString(ParcelMenuWithSearchActivity.this, CustomSharedPreference.KEY_BILL_IP);
