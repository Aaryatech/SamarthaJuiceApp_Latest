                    ...
                    try {
                        if (response.body() != null) {
                            ...
                            if (data == null) {
                                ...
                                try {
                                    String ip = CustomSharedPreference.getString(CancelOrderActivity.this, CustomSharedPreference.KEY_KOT_IP);
                                    PrintHelper printHelper = new PrintHelper(CancelOrderActivity.this, ip, orderDetailStaticList, tableName, PrintReceiptType.VOID_KOT);
